...
🔀 TurboGo Routing Philosophy
TurboGo introduces a custom Tiered Zero-Copy Routing (TZCR) model powered by a fast adaptive router. This design prioritizes speed by avoiding unnecessary allocations and resolving routes in a tiered fashion:
...
<Cards>
  ...
  <Card title="Dependency Injection" href="/docs/dependency-injection/context" />
